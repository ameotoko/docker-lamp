...
function replace_apache_php_ini_values () {
    ...
    sed -i "s/;?memory_limit.*/memory_limit = 512M/g" /etc/php/$1/apache2/php.ini
    sed -i "s/;?max_input_vars.*/max_input_vars = 1000/g" /etc/php/$1/apache2/php.ini
    sed -i "s/;?opcache_enable.*/opcache_enable = 1/g" /etc/php/$1/apache2/php.ini
    sed -i "s/;?opcache.max_accelerated_files.*/opcache.max_accelerated_files = 16000/g" /etc/php/$1/apache2/php.ini
}
...
function replace_cli_php_ini_values () {
    ...
    sed -i "s/;?max_execution_time.*/max_execution_time = 0/g" /etc/php/$1/cli/php.ini
}
